...
- 부울 대수 법칙
   <p align="left"><img width="278" alt="부울-대수-법칙" src="https://user-images.githubusercontent.com/89640705/147545053-2e284505-91e3-4c91-8f82-ce8b7f007dfa.png"></p>
...
- 부울식을 논리 회로로 표현할 수 있음  
  ...
  -> f(x, y) = xy
   <p align="left"><img width="278" alt="동치" src="https://user-images.githubusercontent.com/89640705/147544935-07104c83-da71-416e-a997-c455a090d14b.png"></p>
...
- 동일한 입력값이 주어지면, 실행하면 동일한 출력값을 얻음
- 일정한 시간 안에 출력값을 구할 수 있음
...
- 알고리즘 구조
  ...
  2. 분기 구조 (branch structure)
  3. 반복 구조 (repetition structure)
  4. 점프 구조 (jump structure)

</br>

- 알고리즘 기술 방법
  1. Flowchart
  2. 프로그램 언어 코드 (단점: 문법을 알아야함)
  3. Pseudocode : 구조는 살리고 프로그램 언어와 비슷하게

> 정해진 규칙은 없지만 다른 사람이 알아보기 쉽게 적어야 함.

</br>

- 알고리즘 검증 (verification) : 귀납법을 사용하기 보단, 일반적인 값과 특수한 값을 통해 검증
...
- 해밀톤 순환 알고리즘
  ...
  - 복잡도 함수는 다항식이 아닌 지수식
  - 몹시 어려운 문제
  - 유사한 복잡도 문제 : 암호 해독, 바둑, Bin packing 등

> 해밀톤의 대표적인 문제 : 방문 판매원 문제
>
> - 간선에 비용이 주어짐
> - 일반적으로 완전 그래프
> - 비용이 최소가 되는 해밀톤 순환을 찾는 문제

- 알고리즘
  1. TSP 알고리즘 : 모든 해밀톤 순환을 찾아서 합한 비용이 가장 작은 순환을 선택 (Exhaustive Search)
  2. 단순 TSP 알고리즘
     - 하나의 정점을 선택하여 출발점으로 지정
     - 해당 점점마다 비용이 가장 작은 정점 선택
     - 모든 정점을 선택할 때까지 2) 반복

> 이 알고리즘은 항상 최적의 해를 찾을 수 없음
